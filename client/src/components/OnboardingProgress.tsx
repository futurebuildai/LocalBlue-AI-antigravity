          ...
          {DISPLAY_PHASES.map((phase, index) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "flex flex-col items-center gap-1 px-2 py-1 rounded-md transition-colors min-w-0 flex-shrink-0",
              ...
              >
                <div
                  className={cn(
                    ...
                    status === "current" &&
                      "bg-[#2563EB] text-white ring-2 ring-[#2563EB]/30 ring-offset-2 ring-offset-background",
                    status === "upcoming" &&
